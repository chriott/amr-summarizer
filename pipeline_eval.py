...
def summarize_eval(file):
    ...
    p_s_pair_list = extract_summaries(file)
    ...
    print("Average ROUGE1 scores:", "precision:", total_rouge_1["precision"], "recall:",
          total_rouge_1["recall"], "fscore:", total_rouge_1["fscore"])
    print("Average ROUGE2 scores:", "precision:", total_rouge_2["precision"], "recall:",
          total_rouge_2["recall"], "fscore:", total_rouge_2["fscore"])
    print("Average ROUGEL scores:", "precision:", total_rouge_l["precision"], "recall:",
          total_rouge_l["recall"], "fscore:", total_rouge_l["fscore"])


summarize_eval("proxy-first-20.txt")